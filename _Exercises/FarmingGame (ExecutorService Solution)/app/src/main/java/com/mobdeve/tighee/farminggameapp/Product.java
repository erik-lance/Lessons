...
public abstract class Product {
    ...
    private int productionTime, minCoins, maxCoins;
    private String name;

    public Product(String name, int productionTime, int minCoins, int maxCoins) {
        this.name = name;
     ...
     *   2 --> APPLES
     * */
    public synchronized static Product generateProduct() {
        Random r = new Random();
     ...
     * */
    public synchronized int generateMoney() {
        Random r = new Random();
